...
- Talkware Points remains placeholder.
...
The application is evolving into the Talkware Member App through weekly feature branches.

A future Talkware member should eventually be able to:
